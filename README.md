...
- **一句话创造武器**：阶段 I 首波后、首个 Boss 击杀后与终极 Boss 登场 10 秒后三次重构，一局最终拥有 1 件初始武器与 3 件自创武器。
- **输入行为真的兑现**：直线、主动追踪、折返、螺旋、蛇形、天降与四类目标选择可以自由组合，只有伤害、攻速、数量等数值受预算限制。
- **28 种攻击形态异变**：除分裂、折返与雷链外，还有毒云、燃烧地面、碎冰、引力井、流星雨、蜂群、地雷、吸血、处决刻痕、黑洞等跨武器形态。
- **108+ 实体武器组合**：9 种武器底盘 × 12 种结构基因，搭配元素尾迹与行为特效，避免同色换皮。
